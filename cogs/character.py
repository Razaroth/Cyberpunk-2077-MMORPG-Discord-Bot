...
class CharacterCreationView(discord.ui.View):
    def __init__(self):
        ...
        self.confirm_btn = ConfirmCharacterButton()
...
class AttributeUpgradeView(discord.ui.View):
    def __init__(self, player: dict):
        ...
        self.add_item(AttributeUpgradeSelect(player))
...
class CharacterCog(commands.Cog):
    ...
    async def profile(self, interaction: discord.Interaction, user: discord.Member = None):
        ...
        embed = profile_embed(player, target, equipped, faction_rep)
    ...
    async def levelup(self, interaction: discord.Interaction):
        ...
        view = AttributeUpgradeView(player)
        await interaction.response.send_message(embed=embed, view=view, ephemeral=True)
